...
/*    */ 
/*    */ public class UO_modifier_modele extends Observable
/*    */ {
/* 11 */   BDD bd = null;
/*    */   private String Code;
/*    */   private String Des;
...
/*    */   private String Type;
/*    */ 
/*    */   public UO_modifier_modele(BDD bdd)
/*    */   {
/* 19 */     this.bd = bdd;
/*    */   }
/*    */ 
...
/*    */   }
/*    */ 
/* 38 */   public int maj_uo(String code, String des, String cout, String unite, String type) { int res = this.bd.maj_uo(code, des, cout, unite, type);
/* 39 */     if (res == 1) {
/* 40 */       return 1;
/*    */     }
/*    */ 
 ...
 * Qualified Name:     Modele.UO_modifier_modele
