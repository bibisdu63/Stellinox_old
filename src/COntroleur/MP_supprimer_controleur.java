...
/*    */ 
/*    */ public class MP_supprimer_controleur
/*    */   implements ActionListener
/*    */ {
/* 14 */   MP_supprimer_modele modele = null;
/* 15 */   MP_supprimer_vue vue = null;
/* 16 */   BDD bdd = null;
/*    */ 
/* 18 */   public MP_supprimer_controleur(MP_supprimer_modele modele, MP_supprimer_vue vue, BDD bdd) { this.modele = modele;
/* 19 */     this.vue = vue;
/* 20 */     this.bdd = bdd;
/*    */   }
/*    */ 
...
/* 40 */       if (retour == 0)
/*    */       {
/* 42 */         int ret = this.modele.supp_mp(this.vue.getCode());
/* 43 */         if (ret == 1) {
 ...
 * Qualified Name:     COntroleur.MP_supprimer_controleur
